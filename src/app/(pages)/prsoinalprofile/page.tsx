        ...
        >
          ...
          <Box sx={{ p: 2.5 }}>
            ...
            >
              <Box>
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                  ...
                  >
                    @{posts[0]?.user?.name?.toLowerCase().replace(/\s+/g, "") || "username"}
                  </Typography>
              ...
              >
                {posts[0]?.user?.name?.charAt(0).toUpperCase()}
              </Avatar>
            </Box>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 2 }}>
              <Typography sx={{ fontSize: "15px", color: "#999999" }}>
                  ...
                  <Box sx={{ display: "flex", gap: 1.5 }}>
                    ...
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                      ...
                      <Box sx={{ display: "flex", gap: 0.25, mb: 1 }}>
                        <IconButton size="small" sx={{ color: "#000", p: 0.75 }}>
